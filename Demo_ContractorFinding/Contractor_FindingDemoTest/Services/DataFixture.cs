...

{
    ...
    {
        private static DbContextOptions<ContractorFindingDemoContext> dbContextOptions = new DbContextOptionsBuilder<ContractorFindingDemoContext>()
         .UseInMemoryDatabase(databaseName: "Contractor_FindingDemo")
         .Options;
        public ContractorFindingDemoContext context;

        public DataFixture()
        {
            context = new ContractorFindingDemoContext(dbContextOptions);
